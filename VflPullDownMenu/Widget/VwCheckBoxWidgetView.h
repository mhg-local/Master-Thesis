...
class VGLWAPI VwCheckBoxWidgetView :public IVwWidgetView
{
public:
	VwCheckBoxWidgetView(float fWidth = 0.25f,float fHeight=0.25f, float fBorder = 0.001f,

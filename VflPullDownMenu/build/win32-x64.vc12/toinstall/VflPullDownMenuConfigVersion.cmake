set( VFLPULLDOWNMENU_VERSION_TYPE    "HEAD" )
set( VFLPULLDOWNMENU_VERSION_NAME    "HEAD" )
set( VFLPULLDOWNMENU_VERSION_MAJOR    $WCREV$ )
set( VFLPULLDOWNMENU_VERSION_MINOR    0 )
set( VFLPULLDOWNMENU_VERSION_PATCH    0 )
set( VFLPULLDOWNMENU_VERSION_TWEAK     )
set( VFLPULLDOWNMENU_VERSION_HWARCH  "win32-x64.vc12" )

set( VFLPULLDOWNMENU_VERSION         "$WCREV$" )
set( VFLPULLDOWNMENU_VERSION_EXT     "HEAD_HEAD-$WCREV$-win32-x64.vc12" )
...
if( "${PACKAGE_FIND_VERSION}" STREQUAL "" AND "${PACKAGE_FIND_VERSION_EXT}" STREQUAL "" )
	...
	if( NOT PACKAGE_FIND_VERSION_EXT )
		set( PACKAGE_VERSION "${VFLPULLDOWNMENU_VERSION}" )

		# the cmake native versioning system: just allows an exact match with MAJOR.MINOR.PATCH - just works for releases!
		if( VFLPULLDOWNMENU_VERSION_TYPE STREQUAL "RELEASE" )
			set( PACKAGE_VERSION_EXACT TRUE )
			set( PACKAGE_VERSION_COMPATIBLE TRUE )
			set( PACKAGE_VERSION_UNSUITABLE FALSE )

			if( NOT PACKAGE_FIND_VERSION_MAJOR VERSION_EQUAL VFLPULLDOWNMENU_VERSION_MAJOR )
				set( PACKAGE_VERSION_EXACT FALSE )
				set( PACKAGE_VERSION_COMPATIBLE FALSE )
			endif( NOT PACKAGE_FIND_VERSION_MAJOR VERSION_EQUAL VFLPULLDOWNMENU_VERSION_MAJOR )

			if( PACKAGE_FIND_VERSION_COUNT GREATER 1 )
				if( NOT PACKAGE_FIND_VERSION_MINOR VERSION_EQUAL VFLPULLDOWNMENU_VERSION_MINOR )
					set( PACKAGE_VERSION_EXACT FALSE )
					set( PACKAGE_VERSION_COMPATIBLE FALSE )
				endif( NOT PACKAGE_FIND_VERSION_MINOR VERSION_EQUAL VFLPULLDOWNMENU_VERSION_MINOR )
			endif( PACKAGE_FIND_VERSION_COUNT GREATER 1 )

			if( PACKAGE_FIND_VERSION_COUNT GREATER 2 )
				if( NOT PACKAGE_FIND_VERSION_PATCH VERSION_EQUAL VFLPULLDOWNMENU_VERSION_PATCH )
					set( PACKAGE_VERSION_EXACT FALSE )
					if( NOT PACKAGE_FIND_VERSION_PATCH VERSION_LESS VFLPULLDOWNMENU_VERSION_PATCH )
						set( PACKAGE_VERSION_COMPATIBLE FALSE )
					endif( NOT PACKAGE_FIND_VERSION_PATCH VERSION_LESS VFLPULLDOWNMENU_VERSION_PATCH )
				endif( NOT PACKAGE_FIND_VERSION_PATCH VERSION_EQUAL VFLPULLDOWNMENU_VERSION_PATCH )
			endif( PACKAGE_FIND_VERSION_COUNT GREATER 2 )

			if( PACKAGE_FIND_VERSION_COUNT GREATER 3 )
				if( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_EQUAL VFLPULLDOWNMENU_VERSION_TWEAK )
					set( PACKAGE_VERSION_EXACT FALSE )
					if( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_LESS VFLPULLDOWNMENU_VERSION_TWEAK )
						set( PACKAGE_VERSION_COMPATIBLE FALSE )
					endif( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_LESS VFLPULLDOWNMENU_VERSION_TWEAK )
				endif( NOT PACKAGE_FIND_VERSION_TWEAK VERSION_EQUAL VFLPULLDOWNMENU_VERSION_TWEAK )
			endif( PACKAGE_FIND_VERSION_COUNT GREATER 3 )

		else( VFLPULLDOWNMENU_VERSION_TYPE STREQUAL "RELEASE" )

			set( PACKAGE_VERSION_EXACT FALSE )
			set( PACKAGE_VERSION_COMPATIBLE FALSE )
			set( PACKAGE_VERSION_UNSUITABLE TRUE )

		endif( VFLPULLDOWNMENU_VERSION_TYPE STREQUAL "RELEASE" )

	else( NOT PACKAGE_FIND_VERSION_EXT )
		set( PACKAGE_VERSION "${VFLPULLDOWNMENU_VERSION_EXT}" )
		...
		if( NOT _IN_TYPE OR _IN_TYPE STREQUAL VFLPULLDOWNMENU_VERSION_TYPE )
			# in case of releases, we don't need a name
			if( NOT _IN_NAME AND VFLPULLDOWNMENU_VERSION_TYPE STREQUAL "RELEASE" )
				set( _IN_NAME ${VFLPULLDOWNMENU_VERSION_NAME} )
			endif( NOT _IN_NAME AND VFLPULLDOWNMENU_VERSION_TYPE STREQUAL "RELEASE" )
			...
			#check name
			if( NOT _IN_NAME STREQUAL VFLPULLDOWNMENU_VERSION_NAME )
				set( PACKAGE_VERSION_EXACT FALSE )
				set( PACKAGE_VERSION_COMPATIBLE FALSE )
			else( NOT _IN_NAME STREQUAL VFLPULLDOWNMENU_VERSION_NAME )
				#check versions - these automatically adjust PACKAGE_VERSION_EXACT and PACKAGE_VERSION_COMPATIBLE
				_local_check_valid_subversion( "${_IN_MAJOR}" "${VFLPULLDOWNMENU_VERSION_MAJOR}" FALSE )
				_local_check_valid_subversion( "${_IN_MINOR}" "${VFLPULLDOWNMENU_VERSION_MINOR}" FALSE )
				_local_check_valid_subversion( "${_IN_PATCH}" "${VFLPULLDOWNMENU_VERSION_PATCH}" TRUE )
				_local_check_valid_subversion( "${_IN_TWEAK}" "${VFLPULLDOWNMENU_VERSION_TWEAK}" TRUE )
			endif( NOT _IN_NAME STREQUAL VFLPULLDOWNMENU_VERSION_NAME )

		else( NOT _IN_TYPE OR _IN_TYPE STREQUAL VFLPULLDOWNMENU_VERSION_TYPE )
			set( PACKAGE_VERSION_EXACT FALSE )
			set( PACKAGE_VERSION_COMPATIBLE FALSE )
		endif( NOT _IN_TYPE OR _IN_TYPE STREQUAL VFLPULLDOWNMENU_VERSION_TYPE )
...
if( VISTA_HWARCH AND NOT "${VISTA_HWARCH}" STREQUAL "${VFLPULLDOWNMENU_VERSION_HWARCH}" )
	set( PACKAGE_VERSION_EXACT FALSE )
	set( PACKAGE_VERSION_COMPATIBLE FALSE )
	set( PACKAGE_VERSION_UNSUITABLE TRUE )
endif( VISTA_HWARCH AND NOT "${VISTA_HWARCH}" STREQUAL "${VFLPULLDOWNMENU_VERSION_HWARCH}" )
